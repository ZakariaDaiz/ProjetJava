...
public class ObjetFuturisteFactory implements ObjetFactory {
    ...
    public Objet creerObjetAleatoire() {
        ...
        switch (random) {
            case 0:
                return new Equipement("Epée laser", "Une epee laser", "main", 10);
            case 1:
                return new Equipement("Massue", "Une massue futuriste", "main", 15);
            case 2:
                return new Equipement("Pistolaser", "Pistolaser futuriste", "main", 20);
            case 3:
                return new Equipement("Baguette", "Une baguette futuriste", "main", 10);
            case 4:
                return new Equipement("Lance-missile", "Un lance missile dernier cri", "main", 10);
            case 5:
                return new Equipement("Arme a energie", "Une arme à energie surpuissante", "main", 10);
